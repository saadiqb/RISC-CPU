...
module Phase3_tb;
    ...
    initial begin
        ...
        // --- Branching Test 1 ---
        DUT.datapath_inst.memory_unit.memory[9'h007] = 32'h9A800003; // brmi R5, 3 (Will not branch)
        ...
        // --- Branching Test 2 ---
        DUT.datapath_inst.memory_unit.memory[9'h00B] = 32'hA0800002; // brpl R1, 2 (Will branch to target)
        ...
        DUT.datapath_inst.memory_unit.memory[9'h029] = 32'hF8000000; // halt
        ...
        DUT.datapath_inst.memory_unit.memory[9'h0B5] = 32'hC6000000; // jr   R12 (Return to 0x29)
