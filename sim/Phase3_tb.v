...
module Phase3_tb;
    ...
    initial begin
        ...
        DUT.datapath_inst.memory_unit.memory[9'h009] = 32'h80A7FFFD; // ld  R1, -3(R5)
        DUT.datapath_inst.memory_unit.memory[9'h00A] = 32'hD0000000; // nop
        
        // --- Branching Test 2 ---
        // brpl: Opcode 10101, C2 = --10 (2). 
        ...
        DUT.datapath_inst.memory_unit.memory[9'h012] = 32'h50880000; // andi R1, R1, 0xF
